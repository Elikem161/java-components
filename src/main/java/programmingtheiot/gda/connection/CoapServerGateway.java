...

{
	...
	CoapResource top =
		    new CoapResource("PIOT").add(
		        new CoapResource("ConstrainedDevice").add(
		            new GenericCoapResourceHandler("SystemPerfMsg")));
	// private methods
	...
	private void initDefaultResources()
	{
		...
		GenericCoapResourceHandler updateTelemetryResourceHandler =
			new GenericCoapResourceHandler(
		...
		GenericCoapResourceHandler updateSystemPerformanceResourceHandler =
			new GenericCoapResourceHandler(
